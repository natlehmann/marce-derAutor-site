...
<div id="adminInt">
	...
	<h1>${usuario.id == null ? "CREAR " : "MODIFICAR " } USUARIO</h1>
	...
	<form:form commandName="usuario" action="aceptarEdicion" method="POST">
	
		<form:hidden path="id"/>
	
		<div class="campo">
			<form:label path="nombreApellido">Nombre y apellido</form:label>
			<form:errors path="nombreApellido" cssClass="error"/>
